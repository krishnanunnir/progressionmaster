...
class Book(models.Model):
    ...
    amazon_rating_count = models.IntegerField(null=True, blank=True)
    goodreads_rating = models.FloatField(null=True, blank=True)
    goodreads_rating_count = models.IntegerField(null=True, blank=True)
    ...
    def clean(self):
        if not self.amazon_link and not self.goodreads_link:
